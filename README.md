...
本仓库故意把 **GitHub 说明文档** 和 **实际 Skill 目录** 分开：
...
- 根目录 `README.md` 是给使用者看的
- 真正要安装的目录是 `knowledge-base-organizer/`
...
把仓库里的 `knowledge-base-organizer/` 目录复制到你的 Codex skills 目录：
...
**真正要安装到 Codex 的目录是 `knowledge-base-organizer/`，不是整个仓库根目录。**